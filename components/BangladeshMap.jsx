...
// Component to handle map flying animation
    ...
    return (
        <div className="relative w-full h-[600px] rounded-lg overflow-hidden shadow-lg border-2 border-gray-200">
            ...
            >
                ...
                {/* Render markers for districts with news */}
                            ...
                            <Popup className="custom-popup" maxWidth={350}>
                                <div className="p-2">
                                        ...
                                        {news.slice(0, 3).map((item) => (
                                            <div key={item._id} className="flex gap-2 border-b pb-2 last:border-b-0">
                                                ...
                                                <div className="flex-1 min-w-0">
                                                    <p className="text-xs font-bold text-gray-900 line-clamp-2 mb-1">
                                                        {item.title}
                                                    </p>
                                    ...
                                    <Link
                                        ...
                                        className="block w-full text-center px-4 py-2 bg-accent hover:bg-accent-dark text-white rounded-lg font-semibold text-sm transition-colors"
                                    >
